...
function envoyerDonnees (){
  ...
  var Abb= document.getElementById('Anoir').value;
  ...
  req.open("GET", "partie.php?donnees2="+donneeClient+'&Abandon_noir2='+Abb+'&Proposer_partie_nulle_noir='+pnul+'&Rejeter_partie_nulle_noir='+rej_pn, true);
...
test_client.addEventListener("click", function test(){
  ...
  var test_a = document.getElementById("Anoir").value;
  if (test_a==""){
    console.log('3*********');
    test_a=false;
  }
  ...
  if (test_a==false){
    ...
    console.log('2*****');
    test_a= false;
  }console.log('2nd test : '+test_a);},false);
