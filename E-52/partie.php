<?php
  ...
  if (isset($_GET['Abandon_blanc'])){
    echo '--'.$_GET['Abandon_blanc'];
  }else{
    echo '--0';
  }
  if (isset($_GET['Partie_nulle_blanc'])){
    echo '--'.$_GET['Partie_nulle_blanc'];
  }else{
    echo '--0';
  }
  ...
  if (isset($_GET['Proposer_partie_nulle_blanc'])){
    echo '--'.$_GET['Proposer_partie_nulle_blanc'];
  }else{
    echo '--0';
  }
  if (isset($_GET['Rejeter_partie_nulle_blanc'])){
  ...
  if (isset($_GET['Abandon_noir'])){
    echo '--'.$_GET['Abandon_noir'];
  }else{
    echo '--0';
  }
  if (isset($_GET['Partie_nulle_noir'])){
    echo '--'.$_GET['Partie_nulle_noir'];
  }else{
    echo '--0';
  }
  ...
  if (isset($_GET['Proposer_partie_nulle_noir'])){
    echo '--'.$_GET['Proposer_partie_nulle_noir'];
  }else{
    echo '--0';
  }
  if (isset($_GET['Rejeter_partie_nulle_noir'])){
